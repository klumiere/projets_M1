...
class Case():
    ...
    def __init__(self,ligne,colonne):
        ...
        #print(self.valeur)
        self.bouton=tkinter.Button(self.fen,text=Case.val_case_def, width=1, height=1, bg=lavande,fg=bleu)
...
##pour tester la fonctionnalité de la classe Grille
#g=Grille(18,20)
